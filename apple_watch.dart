                    ...
                    child: ImageSlideshow(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.asset("assets/img/Apple Watch-M1.png",fit: BoxFit.contain),
                        ),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 30, vertical: 30),
                          child: Image.asset("assets/img/watch.png",fit: BoxFit.contain),
                        ),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 30, vertical: 30),
                          child: Image.asset("assets/img/Apple Watch-M1.png",fit: BoxFit.contain),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text(
                        "Discover the Apple smartwatch-a masterful blend of  "
                        "cutting-edge technology and sleek design"
                        "for precision it offers health tracking with bold style ",
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          ...
                          cart.addToCart(
                            Product(
                              name: "Apple Smart Watch-M1",
                              price: "\$200",
                              imagePath: "assets/img/Apple Watch-M1.png",
                            ),
                          );
